...
def main():
    ...
    st.link_button("Share", "https://streamlit.io/", help=None, type="secondary")
    #st.link_button("Share", "", *, help=None, type="secondary", icon=None, disabled=False, use_container_width=False)
